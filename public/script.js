...
function calculateCellSize(){
    // Selvitetään selainikkunan levays ja korkeus ja valitaan näistä pienempi arvo
...
function drawBoard(board) {
    ...
    for (let y = 0; y < BOARD_SIZE; y++) { // Käydään läpi pelikentän rivit
        for (let x = 0; x < BOARD_SIZE; x++) { // Käydään läpi jokaisen rivin sarakkeet
            ...
            // Asetetaan ruudun leveys ja korkeus dynaamisesti laskettuun kokoon
